...
if 'modelicapath' in str(signature(compile_fmu)):
    ...
    kwargs['modelicapath'] = modelicapath

fmu_name = compile_fmu(model, **kwargs)

######################################################################
# Load model
mod = load_fmu(fmu_name, log_level=3)  # 4 # default setting is 3
